// JavaScript Document
var TouchSlide = function(a) { a = a || {}; var b = { slideCell: a.slideCell || "#touchSlide", titCell: a.titCell || ".hd li", mainCell: a.mainCell || ".bd", effect: a.effect || "left", autoPlay: a.autoPlay || !1, delayTime: a.delayTime || 500, interTime: a.interTime || 5000, defaultIndex: a.defaultIndex || 0, titOnClassName: a.titOnClassName || "on", autoPage: a.autoPage || !1, prevCell: a.prevCell || ".prev", nextCell: a.nextCell || ".next", pageStateCell: a.pageStateCell || ".pageState", pnLoop: "undefined " == a.pnLoop ? !0 : a.pnLoop, startFun: a.startFun || null, endFun: a.endFun || null, switchLoad: a.switchLoad || null },
...
document.writeln(".focus{margin:0 auto; position:relative; overflow:hidden;}");
document.writeln(".focus .hd{ width:100%; height:11px;  position:absolute; z-index:1; bottom:5px; text-align:center;}");
document.writeln(".focus .hd ul{ display:inline-block; height:5px; padding:3px 5px; -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:5px; font-size:0; vertical-align:top;}");
document.writeln(".focus .hd ul li{ display:inline-block; width:5px; height:5px; -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:5px; background:#CCCCCC; margin:0 5px;  vertical-align:top; overflow:hidden;}");
document.writeln(".focus .hd ul .on{ background:#046f50;}");
document.writeln(".focus .bd{ position:relative; z-index:0; }");
document.writeln(".focus .bd li img{ width:100%;}");
document.writeln(".focus .bd li a{ -webkit-tap-highlight-color:rgba(0, 0, 0, 0);}");
document.writeln("</style>");


document.writeln("<div id=\"focus\" class=\"focus\">");
...
/*document.writeln("<li><a id=\"lj\" href=\"/zx/\" target=\"_blank\" ><img src=\"http://sm.xzmnyy.com/templets/moban/images/banner1.jpg\"/></a></li>");*/
document.writeln("<li><a id=\"lj\" href=\"javascript:void(0)\" onclick=\"onKST();\" target=\"_blank\" ><img src=\"assets/img/slider/Slide-1.jpg\"  /></a></li>");
document.writeln("<li><a href=\"javascript:void(0)\" onclick=\"onKST();\" target=\"_blank\" ><img src=\"assets/img/slider/Slide-2.jpg\" /></a></li>");
document.writeln("<li><a id=\"lj\" href=\"javascript:void(0)\" onclick=\"onKST();\" target=\"_blank\" ><img src=\"assets/img/slider/Slide-3.jpg\"  /></a></li>");
document.writeln("<li><a href=\"javascript:void(0)\" onclick=\"onKST();\" target=\"_blank\" ><img src=\"assets/img/slider/Slide-4.jpg\" /></a></li>");
document.writeln("</ul>");
document.writeln("</div>");
document.writeln("</div>");
...
if (localhost == '3g.xzmnyy.com') 
{
	document.getElementById("lj").href = "http://3g.xzmnyy.com/zt/sqbp/"; 
	document.getElementById("lj").setAttribute("href","http://3g.xzmnyy.com/zt/sqbp/"); 
}
if (localhost == '4g.xzmales.com') 
{
	document.getElementById("lj").href = "http://4g.xzmales.com/zt/sqbp/"; 
	document.getElementById("lj").setAttribute("href","http://4g.xzmales.com/zt/sqbp/"); 
}
if (localhost == 'sm.xzmnyy.com') 
{
	document.getElementById("lj").href = "http://sm.xzmnyy.com/zt/sqbp/"; 
	document.getElementById("lj").setAttribute("href","http://sm.xzmnyy.com/zt/sqbp/"); 
}
if (localhost == '5g.xzbd120.com') 
{
	document.getElementById("lj").href = "http://5g.xzbd120.com/zt/sqbp/"; 
	document.getElementById("lj").setAttribute("href","http://5g.xzbd120.com/zt/sqbp/"); 
}
if (localhost == '5g.xznkzx.com') 
{
	document.getElementById("lj").href = "http://5g.xznkzx.com/zt/sqbp/"; 
	document.getElementById("lj").setAttribute("href","http://5g.xznkzx.com/zt/sqbp/"); 
}*/
